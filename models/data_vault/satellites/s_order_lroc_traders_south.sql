...
with stage_order as (
    ...
    select distinct
        ...
        employeeid,
        shipvia,
        dss_change_hash_order_lroc_traders_south,
        dss_record_source,
        dss_load_date
...
select distinct
    ...
    stage_order.customerid as customerid,
    stage_order.employeeid as employeeid,
    stage_order.shipvia as shipvia,
    stage_order.dss_change_hash_order_lroc_traders_south as dss_change_hash,
...
where not exists (
    ...
    where stage_order.hk_h_order = target.hk_h_order
      and stage_order.dss_change_hash_order_lroc_traders_south =
