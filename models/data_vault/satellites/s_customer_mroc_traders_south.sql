...
WITH stage_customer AS (
    ...
    SELECT
        ...
        phone,
        fax,
        dss_change_hash_customer_mroc_traders_south,
        dss_record_source,
        dss_load_date
...
new_records AS (
    ...
    SELECT DISTINCT
        ...
        stage_customer.dss_change_hash_customer_mroc_traders_south
            AS dss_change_hash,
    ...
    WHERE NOT EXISTS (
        ...
        WHERE stage_customer.hk_h_customer =
          ...
          AND stage_customer.dss_change_hash_customer_mroc_traders_south =
