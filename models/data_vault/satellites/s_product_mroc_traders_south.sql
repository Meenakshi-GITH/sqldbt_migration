...
WITH stage AS (
    ...
    SELECT
        ...
        quantityperunit,
        unitprice,
        dss_change_hash_product_mroc_traders_south AS dss_change_hash,
        dss_record_source,
        dss_load_date
    FROM {{ ref('stg_product_traders_south') }}
...
SELECT DISTINCT
    ...
    stage.supplierid AS supplierid,
    stage.categoryid AS categoryid,
    stage.quantityperunit AS quantityperunit,
    stage.unitprice AS unitprice,
