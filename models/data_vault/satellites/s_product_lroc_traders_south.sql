...
WITH stage AS (
    ...
    SELECT
        ...
        reorderlevel,
        discontinued,
        dss_change_hash_product_lroc_traders_south AS dss_change_hash,
        dss_record_source,
        dss_load_date
...
SELECT DISTINCT
    ...
    stage.productid AS productid,
    stage.reorderlevel AS reorderlevel,
    stage.discontinued AS discontinued,
