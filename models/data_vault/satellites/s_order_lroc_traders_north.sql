...
with stage_order as (
    ...
    select distinct
        ...
        employeeid,
        shipvia,
        dss_change_hash_order_lroc_traders_north,
        dss_record_source,
        dss_load_date
...
select distinct
    stage_order.hk_h_order,
    stage_order.customerid,
    stage_order.employeeid,
    stage_order.shipvia,
    stage_order.dss_change_hash_order_lroc_traders_north as dss_change_hash,
    stage_order.dss_record_source,
    stage_order.dss_load_date,
...
where not exists (
    ...
    where stage_order.hk_h_order = target.hk_h_order
      and stage_order.dss_change_hash_order_lroc_traders_north =
