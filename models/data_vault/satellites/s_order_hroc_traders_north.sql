...
with stage_order as (
    ...
    select distinct
        hk_h_order,
        freight,
        dss_change_hash_order_hroc_traders_north,
        dss_record_source,
        dss_load_date
...
select distinct
    ...
    stage_order.dss_change_hash_order_hroc_traders_north as dss_change_hash,
...
where not exists (
    ...
    where stage_order.hk_h_order = target.hk_h_order
      and stage_order.dss_change_hash_order_hroc_traders_north =
